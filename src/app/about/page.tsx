  ...
  return (
    <SiteFrame bg="paper">
      <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="relative overflow-hidden rounded-[32px] border border-[rgba(78,52,100,0.12)] bg-paper-2 p-4 shadow-sh-lg">
          <Image
          ...
          />
          <div className="absolute bottom-8 left-8 rounded-full bg-[rgba(255,253,242,0.88)] px-4 py-2 font-mono text-[10px] uppercase tracking-[0.2em] text-brand-purple-700 backdrop-blur">
            Prague / CZ
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <h1 className="mt-3 max-w-[12ch] text-5xl uppercase leading-[0.9] text-brand-purple-700 sm:text-6xl">
              a little more context
            </h1>
            <p className="mt-3 font-script text-3xl text-brand-rose-400">
      ...
      <Section label="✦ a bit more me" title="what that actually means" bg="lavender">
        <div className="grid gap-4 md:grid-cols-3">
          <article className="rounded-[28px] border border-[rgba(78,52,100,0.1)] bg-paper p-6 shadow-sh-md">
            <div className="mb-4">
              <Sloth variant="heart" size={84} className="ml-auto" />
            </div>
            <h2 className="text-2xl uppercase leading-[0.95] text-brand-purple-700">
      ...
      <Section label="♡ contacts" title="the useful bits" bg="paper">
        <div className="grid gap-4 md:grid-cols-2">
          <article className="rounded-[28px] border border-[rgba(78,52,100,0.1)] bg-paper-2 p-6 shadow-sh-md">
            <p className="eyebrow">business</p>
            <p className="mt-3 text-2xl uppercase leading-[0.95] text-brand-purple-700">
              hi@neluska.dev
            </p>
            <p className="mt-3 text-sm leading-6 text-ink-soft">
