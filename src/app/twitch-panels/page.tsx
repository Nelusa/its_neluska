...
export default function TwitchPanelsPage() {
  return (
    <SiteFrame bg="paper">
      <section className="rounded-[32px] border border-[rgba(78,52,100,0.1)] bg-[rgba(255,253,242,0.88)] p-6 shadow-sh-lg sm:p-8">
        <div className="flex flex-wrap items-center gap-3">
          <Link
            href="/brand"
            className="inline-flex items-center rounded-full bg-brand-purple-100 px-4 py-2 font-mono text-[10px] uppercase tracking-[0.16em] text-brand-purple-700 transition hover:bg-brand-purple-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-purple-400 focus-visible:ring-offset-2 focus-visible:ring-offset-paper"
          >
            back to brand kit
          </Link>
        ...
        <h1 className="mt-6 text-[clamp(2.5rem,7vw,5.5rem)] uppercase leading-[0.9] text-brand-purple-700">
          Twitch panels
        </h1>
        <p className="mt-3 font-script text-4xl text-brand-rose-400 sm:text-5xl">
          six useful little blocks
        </p>
        <p className="mt-6 max-w-3xl text-base leading-7 text-ink-soft sm:text-lg">
      ...
      <Section label="♡ practical" title="how to use them" bg="paper">
        <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
          <article className="rounded-[28px] border border-[rgba(78,52,100,0.1)] bg-[rgba(255,253,242,0.92)] p-6 shadow-sh-sm">
